...
export const systemArchitectureIssueCodec: StandardArtifactIssueCodec<SystemArchitecture> = {
  ...
  restore: (payload) =>
    restoreWithPrototype<SystemArchitecture>(SystemArchitecture.prototype, payload),
  traceability: (artifact) =>
    unique(
...
export const requirementAllocationIssueCodec: StandardArtifactIssueCodec<RequirementAllocation> = {
  ...
  restore: (payload) =>
    restoreWithPrototype<RequirementAllocation>(RequirementAllocation.prototype, payload),
  traceability: (artifact) =>
    unique(
